...
class ProjectBorders {
  ...
  static const BorderRadius radiusCircular40 = BorderRadius.all(Radius.circular(40));

  //VERTICAL BORDER
  static const BorderRadius radiusCircularVertical44 = BorderRadius.vertical(bottom: Radius.circular(44));
}
